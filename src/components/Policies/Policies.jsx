  ...
  return (
    <div  className='policies-container'>
      ...
      <ul className="policies-list">
        ...
        <li data-aos='fade-up' className='policy-item'>Single classes that are not paid at the start of the class will be canceled. If the class is rescheduled, a $30 cancelation fee will be added for the cancelation of the first class.</li>
